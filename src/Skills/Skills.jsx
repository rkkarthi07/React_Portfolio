...
const Certificate = (props) => {
    ...
    return (
      <div className=" relative w-max border-black border-2 h-max  m-5 overflow-hidden hover:scale-125 transition-transform rounded">
  ...
  return (
    ...
    <div className="w-full">
        <h1 className="text-3xl text-center font-bold">TECHNICAL SKILLS</h1>
          <div className="grid md:grid-cols-10 sm:grid-cols-7 grid-cols-3 w-full mt-5">
          {techData.map((tech, index) => (
            <div key={index} className="flex-col w-20 p-2 border-black border-3 dark:bg-transparent border-2 justify-items-start border-solid dark:border-white rounded-xl hover:scale-105 transition-transform m-5">
    ...
    <div className="flex  flex-col w-full justify-center item-center mt-7 md:p-10">
      <h1 className="text-3xl text-center font-bold mb-10">CERTIFICATIONS</h1>
        <div className="grid md:grid-cols-4 justify-items-center items-center w-full">
